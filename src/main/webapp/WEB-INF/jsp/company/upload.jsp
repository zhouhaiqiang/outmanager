...
<body>
    <div class="panel-body" style="padding-bottom:0px;width:95%;font-size:12px">
        <div class="panel panel-default">
            <div class="panel-heading">公司信息批量导入</div>
            <div class="panel-body">
               <form  id="fileUpload" action="/outmanager/data/company_import" method="post" enctype="multipart/form-data">
					...
					                            
					        ...
					        <input type="file"  id="excelFile" name="excelFile" size=50>
					         ...
					         <br>
					         <font color='red'>
					             注意：只支持excle文件格式!<a href='/outmanager/filemodel/外包公司维护模板.xls' target='_blank'>模板下载</a>
					         </font>
