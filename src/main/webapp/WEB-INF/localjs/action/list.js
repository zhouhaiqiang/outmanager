...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tb_data').bootstrapTable({
            url: '/outmanager/action/list_json',         //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
    ...
    $('#btn_add').click(function(){
      ...
      $('#btn_edit').click(function(){
          ...
          if(arr.length==1){ 
        	  ...
        	  //业务线
        	  initdroplist($("#ywline"),"/outmanager/config/dict_json",selects[0].ywline,"业务线");
        	  
        	  //业务活动
        	  initdroplist($("#ywaction"),"/outmanager/config/dict_json",selects[0].ywaction,selects[0].ywline);
...
function doExport() {
    ...
    var url="/outmanager/action/export";
...
function Ok_btn(){
    ...
    //调用后台
	updaterecode("/outmanager/action/update",jsonstr);
